...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.126-kirby-problem-4.126-9b82cfb8-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.126"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.126-kirby-problem-4.126-9b82cfb8-v1",
      "problem_contract_sha256": "b2fdefd337e6e2d1764d87ce3435780a0d4f8d280cb8e4c944326dfe2994d270",
      "problem_id": "problem:um-kp-4.126-kirby-problem-4.126-9b82cfb8",
      "route_id": "route:um-kp-4.126-kirby-problem-4.126-9b82cfb8-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.126-kirby-problem-4.126-9b82cfb8-source-fidelity-01",
      "graph_id": "graph:um-kp-4.126-kirby-problem-4.126-9b82cfb8-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.126-kirby-problem-4.126-9b82cfb8-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.126-kirby-problem-4.126-9b82cfb8-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) If M is a closed, orientable hyperbolic 4-manifold then it always has signature 0, because its Pontryagin class vanishes [Che55]. This implies that M bounds a compact, orientable 5-manifold. Is M always a geometric boundary? (b) For general n, suppose that M is a closed hyperbolic n-manifold. Is M a geometric boundary?"
          },
          "statement_sha256": "279a5c8daffa24703811dcef82b4266a51a8a060bf5563735971882095e9beb1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.126-kirby-problem-4.126-9b82cfb8-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.126-kirby-problem-4.126-9b82cfb8-root",
      "route_id": "route:um-kp-4.126-kirby-problem-4.126-9b82cfb8-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.126-ee8220ac158a",
        "url": "https://www.unsolvedmath.com/problems/KP-4.126"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
